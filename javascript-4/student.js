...
let me = {
    firstname: "Kyle",
    superHeroName: "DeKraKn",
    homeTown: "Keller",
    superPowers: ['Sports', 'Movie Knowledge', 'COD'],
...
// console.log(me.superPowerXP);
// console.log(me.profileImage);
//////////////////Step 3////////////////////
...
//////////////////Step 4////////////////////
//Create a function called 'setColor' that takes in one param called arr. 
// Just to make sure that we only ever have three colors, use splice to trim the array to 3 colors. 
...
function setColor(arr) {
    ...
    return background(faveColors[0], faveColors[1], faveColors[2]);
}
