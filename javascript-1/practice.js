...
// Check to see if x is equal to true. If it is, return true as a boolean. 
// If x does not equal true, return false as a boolean
...
// Loop over the passed in arr param. 
// If the number is GREATER than 100, push 'big' as a string to the answers array. 
...
// Using a for loop, loop over the passed in array in reverse and add each item to the new reversed array. 
...
// Using the people array above, let's get a total of the awesomeLevel from all the people. 
// Call the new array 'totallyAwesome'. 
// Use .reduce()
