//////////////////SETUP////////////////////
// Close all other index.html files and open the index.html file in javascript-3/index.html. 
...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one paramter called item. 
// Add the item param to the end of the groceries array created above. 
// Inside of addItem, invoke displayData() which is a function we created that takes care of some of the leg work unrelated to this module.
...
// Invoke the displayData() function again.
...
// Inside of the function check the total number of groceries you need to get using .length. 
// Using an else/if statement, check if the number is greater than or equal to 5, 
// return the string 'That looks like a big trip' from the function. 
...
// You should now see the same thing you saw when you first loaded the page 
